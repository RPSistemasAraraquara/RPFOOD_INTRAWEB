...
function NovoHorario(ADia: string; AAbertura, AFechamento: TTime): TRPFoodEntityHorarioFuncionamento;
begin
...
begin
  ...
  begin
    ...
    if FSegunda then
      FHorarios.Add(NovoHorario('Segunda', SegundaInicio, SegundaFim));
    if FTerca then
      FHorarios.Add(NovoHorario('Terça', TercaInicio, TercaFim));
    if FQuarta then
      FHorarios.Add(NovoHorario('Quarta', QuartaInicio, QuartaFim));
    if FQuinta then
      FHorarios.Add(NovoHorario('Quinta', QuintaInicio, QuintaFim));
    if FSexta then
      FHorarios.Add(NovoHorario('Sexta', SextaInicio, SextaFim));
    if FSabado then
      FHorarios.Add(NovoHorario('Sábado', SabadoInicio, SabadoFim));
    if FDomingo then
      FHorarios.Add(NovoHorario('Domingo', DomingoInicio, DomingoFim));
  end;
  Result := FHorarios;
end;
